...
impl BindingUsage {
    ...
    pub(super) fn eval(&self, env: &Env) -> Result<Val, String> {
        // If no binding exists, then try to make a FuncCall with the binding name. This is because
        // there could be a parameterless function that was mistaken as a binding_def
